...
<meta charset="utf-8">
		...
		<meta name="author" content="Gallo Giorgio">
		<meta name="description" content="Esercizio Tabella">
		
		<title>Tabella Nome Cognome</title>
...
<body>
	<div class="container-fluid">
				<div class="row" style="margin-top: 20px">
					...
					<div class="col-sm-4">
						<form method="GET" action="tabella.php"> 
...
<?php
        $string = file_get_contents("./nomeCognome.json");
